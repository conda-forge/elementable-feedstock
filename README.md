About elementable-feedstock
===========================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/elementable-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15192&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/elementable-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `elementable` can be installed with `conda`:
...
```
mamba install elementable
```

It is possible to list all of the versions of `elementable` available on your platform with `conda`:
...
```
mamba search elementable --channel conda-forge
```
...
mamba repoquery search elementable --channel conda-forge

# List packages depending on `elementable`:
mamba repoquery whoneeds elementable --channel conda-forge

# List dependencies of `elementable`:
mamba repoquery depends elementable --channel conda-forge
```
